...
import { removeAdminWallet } from "@/services/user/userService";

const RemoveWalletUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await removeAdminWallet(walletAddress);
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-6">
          <div>
            ...
            <Input type="text" placeholder="0x123456789" name="walletAddress" />
          </div>
          <div>
...
export default RemoveWalletUser;
